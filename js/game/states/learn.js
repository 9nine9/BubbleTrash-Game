Scene.Learn = function () {
    this.reg = {};
};

Scene.Learn.prototype = {
    render : function(){
    ...
    create : function(){
        ...
        this.textTutor = this.game.add.text(this.game.world.centerX, this.game.world.centerY, "", { font: "64px Josefin Sans", fill: "#ffffff", align: "center" });
        this.textTutor.anchor.setTo(0.5, 0.5);
       ...
       //first wall
        ...
        this.signLeft = this.add.sprite(this.game.world.centerX - 400 , this.game.height - 100, null);
        this.signLeft.anchor.setTo(0.5);
        this.signLeft.scale.setTo(scaleRatio/3, scaleRatio/3);
        this.signRight = this.add.sprite(this.game.world.centerX + 400 , this.game.height - 100, null);
    ...
    groundHit : function(ground,box){
        ...
        switch(this.checkBox){
            case 'green':
                str = 'Pilih Tong Sampah Hijau\nUntuk Memakan Sampah Organik';
                break;
            case 'yellow':
                str = 'Pilih Tong Sampah Kuning\nUntuk Memakan Sampah Plastik';
                break;
            case 'blue':
                str = 'Pilih Tong Sampah Biru\nUntuk Memakan Sampah Kertas';
                break;
            case 'black':
                str = 'Pilih Tong Sampah Hitam\nUntuk Memakan Sampah Logam';
                break;
            case 'white':
                str = 'Pilih Tong Sampah Putih\nUntuk Memakan Sampah Kaca';
                break;
            case 'red':
                str = 'Pilih Tong Sampah Merah\nUntuk Memakan Sampah Berbahaya';
                break;
        }

        this.textTutor.text = str;
        ...
        if(rand < 50){
            ...
            this.signLeft.loadTexture('left');
            this.signRight.loadTexture(null);
            ...
            this.signLeft.loadTexture(null);
            this.signRight.loadTexture('right');
    ...
    initBox(height){
        ...
        var obj = this.trash[this.currentTrash][index];
        this.createBox(obj, this.game.world.centerX, height);

        if(this.currentTrash < 6){
            this.currentTrash++;
        }
